...
class SystemPolicyV1Beta1AsyncClient:
    ...
    common_billing_account_path = staticmethod(SystemPolicyV1Beta1Client.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(SystemPolicyV1Beta1Client.parse_common_billing_account_path)
    common_folder_path = staticmethod(SystemPolicyV1Beta1Client.common_folder_path)
    parse_common_folder_path = staticmethod(SystemPolicyV1Beta1Client.parse_common_folder_path)
    common_organization_path = staticmethod(SystemPolicyV1Beta1Client.common_organization_path)
    parse_common_organization_path = staticmethod(SystemPolicyV1Beta1Client.parse_common_organization_path)
    common_project_path = staticmethod(SystemPolicyV1Beta1Client.common_project_path)
    parse_common_project_path = staticmethod(SystemPolicyV1Beta1Client.parse_common_project_path)
    common_location_path = staticmethod(SystemPolicyV1Beta1Client.common_location_path)
    parse_common_location_path = staticmethod(SystemPolicyV1Beta1Client.parse_common_location_path)
    ...
    get_transport_class = functools.partial(type(SystemPolicyV1Beta1Client).get_transport_class, type(SystemPolicyV1Beta1Client))
