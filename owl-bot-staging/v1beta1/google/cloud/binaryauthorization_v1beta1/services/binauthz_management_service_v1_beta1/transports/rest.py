...
from .base import BinauthzManagementServiceV1Beta1Transport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class BinauthzManagementServiceV1Beta1RestTransport(BinauthzManagementServiceV1Beta1Transport):
