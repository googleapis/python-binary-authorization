...
from google.cloud.binaryauthorization_v1.services.system_policy_v1.transports.base import _GOOGLE_AUTH_VERSION
...
def test_system_policy_v1_client_client_options_credentials_file(client_class, transport_class, transport_name):
