...
def test_binauthz_management_service_v1_client_get_mtls_endpoint_and_cert_source(
    client_class,
):
...
def test_binauthz_management_service_v1_client_create_channel_credentials_file(
    client_class, transport_class, transport_name, grpc_helpers
):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(credentials_file="credentials.json")
...
def test_get_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v1/{name=projects/*/policy}" % client.transport._host, args[1]
        )
...
def test_update_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{policy.name=projects/*/policy}" % client.transport._host, args[1]
        )
...
def test_create_attestor_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{parent=projects/*}/attestors" % client.transport._host, args[1]
        )
...
def test_get_attestor_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{name=projects/*/attestors/*}" % client.transport._host, args[1]
        )
...
def test_update_attestor_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v1/{attestor.name=projects/*/attestors/*}" % client.transport._host,
            args[1],
        )
